...
YIO_REMOTE_SOFTWARE_DEPENDENCIES = qt5base qt5connectivity qt5graphicaleffects qt5imageformats qt5quickcontrols qt5quickcontrols2 qt5tools qt5virtualkeyboard qt5websockets yio-integrations-library yio-wiringpi
...
define YIO_REMOTE_SOFTWARE_CONFIGURE_CMDS
    ...
    @mkdir -p $(@D)/build
    (cd $(@D)/build; $(TARGET_MAKE_ENV) YIO_BIN=$(@D)/bin YIO_SRC="$(STAGING_DIR)/usr/include/yio" $(HOST_DIR)/bin/qmake $(@D) $(YIO_REMOTE_SOFTWARE_QMAKE_ARGS) "YIO_BUILD_VERSION = $(YIO_REMOTE_SOFTWARE_VERSION)")
